        ...
        <form method="POST" action="{{ route('consultations.store') }}" class="space-y-6 sm:space-y-8">
            ...
            <div x-data="cityAutoFill(@js(old('city', '')), @js(old('province', '')), @js(old('district', '')))" class="space-y-5 sm:space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-6">
                    <div class="space-y-2 relative">
                        ...
                        <input type="text" id="district" name="district" value="{{ old('district') }}" maxlength="100" x-model="district"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="space-y-2">
                    ...
                    <input type="text" data-datepicker data-datepicker-placeholder="Pilih tanggal" id="consultation_date" name="consultation_date" value="{{ old('consultation_date', now()->format('Y-m-d')) }}"
            ...
            <div class="space-y-2">
                <label for="notes" class="block text-[10px] font-bold text-on-surface-variant uppercase tracking-widest px-1">Keterangan Follow-Up Awal</label>
